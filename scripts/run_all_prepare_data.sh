...
command="python prepare_data.py --model gpt-4o \
         --topics bookRecommendation coding datingConsultation email foodRecommendation \
                  legalConsultation medicalConsultation movieRecommendation onlineShopping sportsRecommendation \
                  studyConsultation therapy \
