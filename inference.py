...
import mem0_lib
import utils
from lib import MEM0_MODELS, OPENAI_MODELS, re_search_list
...
class Evaluation:
    def __init__(self, args):
        ...
        if re_search_list(r"gemini", self.args["models"]["llm_model"]):
        ...
        elif re_search_list(r"llama", self.args["models"]["llm_model"]):
        ...
        for block_idx, ((file_name, time_period), conversation) in enumerate(chosen_blocks):
            ...
            processed_blocks_dict[latest_ts] = {
                "conversation": processed_conversation[
                    0
                ],  # idx 0 corresponds to the conversation in the required format, either string or api_dict
                "file_name": file_name,
